...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  // ==========================================
  // 17. PAPELERÍA (Con control de stock y precios ajustables)
  // ==========================================
  { id: 'p-foto-bn', name: 'Fotocopia Blanco y Negro', area: 'papeleria', category: 'Fotocopias e Impresiones', price: 200, cost: 50, stock: 100, minStock: 20, isActive: true, trackStock: true },
  { id: 'p-foto-color', name: 'Fotocopia a Color', area: 'papeleria', category: 'Fotocopias e Impresiones', price: 800, cost: 200, stock: 100, minStock: 20, isActive: true, trackStock: true },
  { id: 'p-imp-bn', name: 'Impresión Blanco y Negro', area: 'papeleria', category: 'Fotocopias e Impresiones', price: 500, cost: 100, stock: 100, minStock: 20, isActive: true, trackStock: true },
  { id: 'p-imp-color', name: 'Impresión a Color', area: 'papeleria', category: 'Fotocopias e Impresiones', price: 1200, cost: 350, stock: 100, minStock: 20, isActive: true, trackStock: true },
  { id: 'p-lapicero-negro', name: 'Lapicero Negro', area: 'papeleria', category: 'Escritura y Útiles', price: 1500, cost: 800, stock: 35, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-lapicero-azul', name: 'Lapicero Azul', area: 'papeleria', category: 'Escritura y Útiles', price: 1500, cost: 800, stock: 35, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-lapicero-rojo', name: 'Lapicero Rojo', area: 'papeleria', category: 'Escritura y Útiles', price: 1500, cost: 800, stock: 25, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-lapiz', name: 'Lápiz Mirado No. 2', area: 'papeleria', category: 'Escritura y Útiles', price: 1200, cost: 600, stock: 40, minStock: 8, isActive: true, trackStock: true },
  { id: 'p-cuaderno-100', name: 'Cuaderno 100 Hojas', area: 'papeleria', category: 'Papeles y Cuadernos', price: 4500, cost: 3000, stock: 20, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-cuaderno-50', name: 'Cuaderno 50 Hojas', area: 'papeleria', category: 'Papeles y Cuadernos', price: 3000, cost: 2000, stock: 20, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-carpeta-cartulina', name: 'Carpeta Cartulina', area: 'papeleria', category: 'Carpetas y Sobres', price: 1200, cost: 600, stock: 30, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-carpeta-plastica', name: 'Carpeta Plástica', area: 'papeleria', category: 'Carpetas y Sobres', price: 2000, cost: 1100, stock: 25, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-sobre-carta', name: 'Sobre de Manila Carta', area: 'papeleria', category: 'Carpetas y Sobres', price: 500, cost: 200, stock: 50, minStock: 10, isActive: true, trackStock: true },
  { id: 'p-sobre-oficio', name: 'Sobre de Manila Oficio', area: 'papeleria', category: 'Carpetas y Sobres', price: 700, cost: 300, stock: 50, minStock: 10, isActive: true, trackStock: true },
  { id: 'p-borrador', name: 'Borrador de Nata', area: 'papeleria', category: 'Escritura y Útiles', price: 800, cost: 350, stock: 35, minStock: 8, isActive: true, trackStock: true },
  { id: 'p-sacapuntas', name: 'Sacapuntas Metálico', area: 'papeleria', category: 'Escritura y Útiles', price: 1000, cost: 450, stock: 30, minStock: 5, isActive: true, trackStock: true },
  { id: 'p-pegante', name: 'Pegante en Barra', area: 'papeleria', category: 'Escritura y Útiles', price: 2500, cost: 1400, stock: 25, minStock: 5, isActive: true, trackStock: true },
];
